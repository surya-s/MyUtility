...
public interface QueryParams {
	...
	/**
	 * To check if parameter expects date as string. TO_DATE function can be misued in queries.
	 ...
	 * To support backward compatibility (previouly parameters hard replacement works well in this case), if parameter is bound with TO_DATE,
